#include "majercik2022_renderer.h"


#define PROBE_RGEN_SHADER           "majercik2022_probe_raygen.spv"
#define PROBE_RESERVOIR_RGEN_SHADER "majercik2022_probe_reservoir_raygen.spv"
#define SHADING_UPDATE_COMP_SHADER  "majercik2022_shading_update_comp.spv"
#define RESERVOIR_RGEN_SHADER       "majercik2022_reservoir_raygen.spv"
#define FINAL_RGEN_SHADER           "majercik2022_final_raygen.spv"
...
Majercik2022::Majercik2022(Device* device)
...
Majercik2022::~Majercik2022() {}

void Majercik2022::initRenderer() {
	createBuffers();
...
void Majercik2022::cmdRenderFrame(size_t index, VkCommandBuffer commandBuffer) {
...
void Majercik2022::updateRendererUniforms(size_t index) {
...
void Majercik2022::parseRendererInput(const InputEntry& inputEntry) {
...
void Majercik2022::createBuffers() {
	...
	renderSettingsBuffers.bufferProperties.bufferSize = sizeof(Majercik2022::RenderSettings);
...
void Majercik2022::createDescriptorCollection() {
...
void Majercik2022::createProbeReservoirPipeline() {
...
void Majercik2022::createProbePipeline() {
...
void Majercik2022::createShadingUpdatePipeline() {
...
void Majercik2022::createReservoirPipeline() {
...
void Majercik2022::createFinalPipeline() {
...
Vector2u Majercik2022::getIrradianceFieldSurfaceExtend() const {
