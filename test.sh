...
# build/RayTrace res/renderer/Majercik2019_median.renderer res/scene/cornell_box_with_blocks.scene 1280 720
...
build/RayTrace res/renderer/Bitterli2020.renderer res/scene/labyrinth.scene 1280 720
...
# build/RayTrace res/renderer/meta_normal_vector.renderer res/scene/cornell_box_with_blocks.scene 1280 720 out/meta_normal.ppm 5
